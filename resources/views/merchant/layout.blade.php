...
<head>
    ...
    <title>@yield('title', 'Merchant Dashboard') - Edfundo Pay</title>
...
<div class="flex">
    ...
    <aside class="sidebar">
        ...
        <nav class="flex-1 pt-4 pb-2 overflow-y-auto">
            ...
            <a href="{{ route('merchant.invoices.index') }}"
               class="nav-link {{ request()->routeIs('merchant.invoices*') ? 'active' : '' }}">
                <i class="fas fa-link"></i>
                <span>Payment Links</span>
            </a>

            <a href="{{ route('merchant.payments.index') }}"
               class="nav-link {{ request()->routeIs('merchant.payments*') ? 'active' : '' }}">
            ...
            <a href="{{ route('merchant.consumers.index') }}"
               class="nav-link {{ request()->routeIs('merchant.consumers*') ? 'active' : '' }}">
    ...
    <div class="main-content flex-1">
        ...
        <div class="topbar">
            <div>
                <h1 class="text-base font-700 text-gray-800 font-bold">@yield('page-title', 'Dashboard')</h1>
...
@else
    {{-- Not authenticated — just render content (login page etc.) --}}
    @yield('content')
@endauth
