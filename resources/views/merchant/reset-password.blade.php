...
<head>
    ...
    <title>Reset Password - Edfundo Pay</title>
    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        .btn-gradient {
            ...
            color: white; font-weight: 700; padding: 12px;
            border-radius: 10px; border: none; cursor: pointer;
            font-size: 15px; width: 100%; transition: opacity 0.15s;
        }
...
<body style="background-color: #f5f6fa; min-height: 100vh; display: flex; align-items: center; justify-content: center;">
    <div style="width: 100%; max-width: 440px; padding: 0 16px;">
        ...
        <div style="text-align: center; margin-bottom: 32px;">
            ...
            <h1 style="font-size: 22px; font-weight: 800; color: #000026; margin: 0;">New Password</h1>
            <p style="font-size: 14px; color: #9ca3af; margin-top: 4px;">Choose a strong password for your account</p>
        </div>
        ...
        <div style="background: white; border-radius: 16px; padding: 36px; box-shadow: 0 4px 24px rgba(0,0,38,0.08); border: 1px solid #eef0f5;">
            ...
            <form method="POST" action="{{ route('merchant.password.reset.post') }}">
                @csrf
                ...
                <div style="margin-bottom: 18px;">
                    <label for="password" style="display: block; font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 6px;">New password</label>
                    <input type="password" name="password" id="password" required
                        class="form-input" placeholder="Minimum 8 characters">
                </div>

                <div style="margin-bottom: 28px;">
                    <label for="password_confirmation" style="display: block; font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 6px;">Confirm new password</label>
                    <input type="password" name="password_confirmation" id="password_confirmation" required
                        class="form-input" placeholder="Repeat your new password">
                </div>

                <button type="submit" class="btn-gradient">Set New Password</button>
            </form>
        </div>
