    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card p-6">
                ...
                <div class="mb-5">
                    <label class="form-label">Product <span class="text-red-400">*</span></label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-5">
                    <div>
                        ...
                        <input type="number" step="0.01" name="invoice_details[0][fee]" id="feeInput"
                            value="{{ old('invoice_details.0.fee') }}" required min="0"
                    ...
                    <div>
                        ...
                        <input type="text" name="invoice_details[0][title]" id="titleInput"
                            value="{{ old('invoice_details.0.title') }}"
                            class="form-input"
...
// Watch consumer select for summary
