...
<div class="max-w-lg">
    <div class="card p-6 mb-6">
        <form method="POST" action="{{ route('admin.merchants.store') }}" enctype="multipart/form-data">
            ...
            <div id="panel-none" class="{{ old('fallback_type', '') === '' ? '' : 'hidden' }} mb-5">
                <label class="form-label">Custom Message (optional)</label>
                <textarea name="fallback_none_note" rows="3" class="form-input"
                    placeholder="e.g. Please pay the coach directly via debit or credit card.">{{ old('fallback_none_note') }}</textarea>
