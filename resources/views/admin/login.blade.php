...
<head>
    ...
    <title>Admin Login - Edfundo Pay</title>
...
<body style="background-color: #000026; min-height: 100vh; display: flex; align-items: center; justify-content: center;">
    ...
    <div style="width: 100%; max-width: 440px; padding: 0 16px;">
        ...
        <div style="text-align: center; margin-bottom: 32px;">
            ...
            <h1 style="font-size: 22px; font-weight: 800; color: #ffffff; margin: 0;">Admin Portal</h1>
            <p style="font-size: 14px; color: rgba(255,255,255,0.4); margin-top: 4px;">Edfundo Pay Operations</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.login.post') }}">
                ...
                <div style="margin-bottom: 18px;">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required
                        class="form-input" placeholder="admin@edfundo.com">
                </div>
                ...
                <button type="submit" class="btn-gradient">Sign in to Admin</button>
            </form>
        </div>
