    ...
    <div class="min-h-screen flex flex-col items-center justify-center py-10 px-4">
        ...
        <div class="pay-card w-full max-w-md overflow-hidden">
            ...
            <div class="px-6 pb-8">
                ...
                {{-- Get AED 50 incentive badge + tooltip --}}
                <div class="mb-1 flex items-center justify-center gap-2">
                    <span style="display:inline-block;padding:3px 12px;font-size:11px;font-weight:700;letter-spacing:0.03em;text-transform:uppercase;color:#ffffff;background:linear-gradient(90deg,#00C8AF 0%,#015AD7 100%);border-radius:999px;white-space:nowrap;">Get AED 50</span>
                    <details style="display:inline-block;">
                        <summary style="cursor:pointer;display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;border-radius:50%;background:#e5e7eb;color:#4b5563;font-size:11px;font-weight:700;list-style:none;">&#9432;</summary>
                        <div style="margin-top:4px;width:200px;max-width:80vw;padding:8px 10px;background:#374151;color:#ffffff;font-size:11px;line-height:1.4;border-radius:6px;box-shadow:0 2px 8px rgba(0,0,0,0.2);">New to Edfundo? Get AED 50 when you join Edfundo after completing your payment. T&amp;Cs apply.</div>
                    </details>
                </div>
                ...
                <form method="POST" action="{{ route('public.invoice.pay', $invoice->uuid) }}" id="paymentForm">
                    ...
                    <p style="margin:0 0 8px;font-size:13px;color:#6b7280;text-align:center;">&#128274; Edfundo Pay securely connects you to your bank using AlTareq.</p>
